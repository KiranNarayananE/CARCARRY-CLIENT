...
const CompletedTrips = () => {
  ...
  const fetchBookingHistory = async (token) => {
    try {
      const response = await AxiosInstance.get("/booking-history", { headers: { Authorization: `Bearer ${token}` } });
      return response;
    } catch (error) {
      ...
      <section class="text-white body-font">
        <div class="container px-5 py-10 mx-auto">
          <div class="flex flex-col text-start w-full mb-20">
            ...
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-real-blue">Completed Trips</h1>
