  ...
  return (
    <>
      <aside
        ...
        } bg-regal-blue  border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700`}
        aria-label="Sidebar">
        <div className="h-full px-3 pb-4 overflow-y-auto bg-regal-blue dark:bg-gray-800">
          <ul className="space-y-2">
            ...
            <Link
                ...
                <span className="ml-3 text-real-orange">Dashboard</span>
              
              </Link>
            </li>
            <li>
              <Link
                to="/driver/upcoming-trips"
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg
                  aria-hidden="true"
                ...
                <span className="flex-1 ml-3 whitespace-nowrap text-real-orange">Upcomming Trips</span>
              </Link>
            </li>
            <li>
              <Link
                ...
                <span className="flex-1 ml-3 whitespace-nowrap text-real-orange"> Available</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <Link
                ...
                <span className="flex-1 ml-3 whitespace-nowrap text-real-orange">Wallet</span>
                </Link>
            </li>
            <li>
            <Link
                ...
                <span className="flex-1 ml-3 whitespace-nowrap text-real-orange">Earning Report</span>
                </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              <button
                ...
                className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <ExitToAppIcon className="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
                <span className="flex-1 ml-3 whitespace-nowrap text-real-orange">Sign out</span>
              </button>
            </li>
          </ul>
        </div>
